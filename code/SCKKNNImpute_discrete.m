function imputed2 = SCKKNNImpute_discrete(missing, sigma, K_proportion)
% SCKKNNImpute_discrete Impute missing discrete data using Structural Causal Model with K-Nearest Neighbors.
%
%   imputed2 = SCKKNNImpute_discrete(missing)
%   imputed2 = SCKKNNImpute_discrete(missing, sigma)
%   imputed2 = SCKKNNImpute_discrete(missing, sigma, K_proportion)
%
%   Inputs:
